...
public class MainActivity extends Activity {
	...
	private int[] mnMenuBtns = {
			...
			R.id.shoplistbtnmpointairtime, R.id.shoplistbtndpointairtime, R.id.shoplistbtncelcom, R.id.shoplistbtntri,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mbtnPay.setOnTouchListener(new View.OnTouchListener() {
			@Override
		...
		for (int i = 0; i < TOTALMENUBTNS; i++) {
			...
			final int fi = i;
			mbtnMenuBtns[i].setOnClickListener(new View.OnClickListener() {
		...
		switch (paymentid) {
			...
			case UPOINT: // upoint
				...
				altbld.setMessage("Denom list or fixed denom ?")
						...
						.setNegativeButton("Fixed Denom (IDR 1000)", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
			...
			case XLAIRTIME: // XL Airtime
				...
				altbld.setMessage("Denom list or fixed denom ?")
						...
						.setNegativeButton("Fixed Denom (IDR 20000)", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
			...
			case INDOSAT: // indosat airtime
				...
				altbld.setMessage("Denom list or fixed denom ?")
						...
						.setNegativeButton("Fixed Denom (IDR 10000)", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
			...
			case MPOINT: // mpoint
				...
				altbld.setMessage("Choose your language ?\n(Dutch language here just an example)")
						...
						.setNegativeButton("Dutch", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
	...
	private void paymentATMs(final String channel) {
		...
		altbld.setMessage("Denom list or fixed denom ?")
				...
				.setNegativeButton("Fixed Denom (IDR 90000)", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
	...
	private void paymentMPoint() {
		...
		altbld.setMessage("Denom list or fixed denom ?")
				...
				.setNegativeButton("Fixed Denom (MYR 10)", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						mMimopay.setCurrency("MYR");
	...
	private void paymentDPoint() {
		...
		altbld.setMessage("Denom list or fixed denom ?")
				...
				.setNegativeButton("Fixed Denom (MYR 5)", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						mMimopay.setCurrency("MYR");
	...
	private void paymentCelcom() {
		...
		altbld.setMessage("Denom list or fixed denom ?")
				...
				.setNegativeButton("Fixed Denom (MYR 1)", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						mMimopay.setCurrency("MYR");
...
class ClearGLSurfaceView extends GLSurfaceView {
	...
	Runnable mStageRunnable = new Runnable() {
		@Override
		public void run() {
